...
//if the current node does not have any children, add to the count and stop the search (base case)
// if the current node does have child nodes, check if any of those nodes are leaves (recrusive case)
